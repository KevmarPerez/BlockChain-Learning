...
def get_contract(contract_name):
    ...
    defined, otherwise, it will deploy a mock version of that contract, and 
...
def fund_with_link(contract_address, account=None, link_token=None, amount= (10**17)): # 0.1LINK
